...
import org.tiny.component.IProvider
...
class App : BaseApplication() {
    ...
    override fun onCreate() {
        ...
        App.context = this
        DbHelper.init(this)
        mComponentManager.addProvider(IProvider::class.java, ComponentImpl())
        mComponentManager.addComponent(Contracts.COMPONENT_MAIN)
    }

    override fun onTerminate() {
        super.onTerminate()
        mComponentManager.removeProvider(IProvider::class.java)
